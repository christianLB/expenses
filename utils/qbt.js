...
exports.connect = async (host, username, password) => {
  ...
  try {
    ...
    return {
      ...
      addTorrent: async (urls, savepath) => {
        return await addTorrent(options, cookie, urls, savepath)
      },
      /**
...
// TODO: addTorrent()
async function addTorrent(options, cookie, urls, savepath) {
  await performRequest(options, cookie, '/torrents/add', { savepath: savepath, urls: encodeURI(urls) })
  return
}
